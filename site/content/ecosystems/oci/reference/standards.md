...
| [Referrers API](https://github.com/opencontainers/distribution-spec/blob/main/spec.md#listing-referrers) | `GET /v2/<name>/referrers/<digest>` and `OCI-Subject` on push                    |

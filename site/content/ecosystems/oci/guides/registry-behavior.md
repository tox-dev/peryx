...
reasoning in [why peryx accepts a non-sha256 content digest](@/ecosystems/oci/registry-behavior.md#digest-handling).
...
- Registry behavior rationale: [registry behavior](@/ecosystems/oci/registry-behavior.md)
- `/v2/` upload verbs and success codes: [HTTP endpoints](@/ecosystems/oci/reference/endpoints.md)

...
A network with no route to Docker Hub can still pull public images through peryx, as long as the images land in
peryx's content-addressed blob store before the gap closes. Two topologies cover the common cases: a cache pinned

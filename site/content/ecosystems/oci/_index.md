...
[getting-started tutorial](@/ecosystems/oci/tutorials/getting-started.md) for one cached and one hosted index. Use
[run a container registry](@/ecosystems/oci/guides/container-registry.md) for cached, hosted, and virtual roles under
one route. OCI-specific options belong under `[index.settings]`; see
[index settings](@/ecosystems/oci/reference/settings.md).
...
- Repository-scoped digest reads and single-platform tag responses:
  [manifest serving](@/ecosystems/oci/manifest-serving.md)

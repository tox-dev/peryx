...
revalidations (`refreshes`, mostly `304`s with no body). The [dashboard](@/guides/web-ui.md) shows the same numbers with
per-project drill-down, and [`/metrics`](@/guides/monitor.md) feeds Prometheus.

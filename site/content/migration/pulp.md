...
`/pypi/{base_path}/simple/`, and its pull-through composes: overlays can layer mirrors of mirrors, where Pulp documents
that [chaining pull-through indices does not work](https://pulpproject.org/pulp_python/docs/user/guides/host/).

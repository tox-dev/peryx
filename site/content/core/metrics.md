...
Core owns registration rules and shared runtime collectors. Owner crates own serving, metadata, publication, quota,
catalog, and protocol metric families. Their guides list exact series names, roles, and alert queries.

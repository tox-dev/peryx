...
Content owners call the same selection, transfer, verification, and staging service. Their client routes and fallback
responses remain outside availability crates.

...
This release provides two typed domains:

- `policy.decisions`: bounded repository policy history
- `usage.downloads`: durable download and byte totals by repository subject

### `policy.decisions`

| Column                                         | Type      | Meaning                                                                |
| ---------------------------------------------- | --------- | ---------------------------------------------------------------------- |
| `repository`, `project`, `version`, `filename` | string    | Shared identifiers supplied by the ecosystem driver                    |
...
| Column                  | Type   | Meaning                                         |
| ----------------------- | ------ | ----------------------------------------------- |
| `repository`, `project` | string | Repository and driver subject                   |
...
columns. Default ordering uses descending `evaluated_at` for policy decisions and descending `downloads` for usage.

...
Status: implemented through core retention contracts and PyPI version ordering. See
[Policy settings](@/reference/policy.md#retention-ordering). The text below records the original proposal.

Depends on #30 and #32. Related to #31 and #27.

## Problem

peryx does not enforce repository size limits or provide a supported cleanup workflow. Stored content can grow through
...
- Quota failures return clear errors before peryx commits new hosted uploads or mirror artifacts.

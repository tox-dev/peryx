...
inspect [upload quotas](@/reference/policy.md#upload-quotas) when an expected denial succeeds.

See [Revoked content](@/revoked-content.md) for yank and digest-revocation behavior.

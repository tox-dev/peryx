...
fn test_prepare_accepts_record_self_size_and_stronger_hashes() {
    ...
    let bytes = wheel_zip(
        ...
        Some(record_with_self_size(
            &[
                ("Flask/__init__.py", init.as_slice(), RecordHash::Sha384),
                ("flask-1.0.dist-info/METADATA", metadata.as_slice(), RecordHash::Sha512),
                ("flask-1.0.dist-info/WHEEL", wheel.as_slice(), RecordHash::Sha256),
            ],

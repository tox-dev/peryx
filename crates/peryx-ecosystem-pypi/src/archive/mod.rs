...
use peryx_storage::archive::{ArchiveFormat, ArchiveProfile, generic_format, generic_member_kind};
...
pub fn list_members(filename: &str, bytes: &[u8]) -> Result<Vec<Member>, ArchiveError> {
    peryx_storage::archive::list_members(&PROFILE, filename, bytes)
}
...
pub fn list_members_path(filename: &str, path: &Path) -> Result<Vec<Member>, ArchiveError> {
    peryx_storage::archive::list_members_path(&PROFILE, filename, path)
}
...
pub fn list_members_nested_path(
    ...
    peryx_storage::archive::list_members_nested_path(&PROFILE, filename, path, containers)
}
...
pub fn read_member(filename: &str, bytes: &[u8], member: &str) -> Result<Vec<u8>, ArchiveError> {
    peryx_storage::archive::read_member(&PROFILE, filename, bytes, member)
}
...
pub fn read_member_chunk(
    ...
    peryx_storage::archive::read_member_chunk(&PROFILE, filename, bytes, member, offset, limit)
}
...
pub fn read_member_chunk_path(
    ...
    peryx_storage::archive::read_member_chunk_path(&PROFILE, filename, path, member, offset, limit)
}
...
pub fn read_text_member_chunk_nested_path(
    ...
    peryx_storage::archive::read_text_member_chunk_nested_path(
        &PROFILE, filename, path, containers, member, offset, limit,
    )
}

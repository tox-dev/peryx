//! The velox web UI: a Leptos application, server-side rendered by the velox binary and hydrated in
    ...
    view! {
        <header class="site-header">
            <nav>
                ...
                <div class="nav-links">
                    <a href="/">"Dashboard"</a>
                    <a href="https://velox.readthedocs.io/" rel="external">"Docs"</a>
                    <a href="https://github.com/tox-dev/velox" rel="external">"GitHub"</a>
                    <ThemeToggle />
                </div>
            </nav>
        </header>
...
fn BrandMark() -> impl IntoView {
    view! {
        <svg width="30" height="20" viewBox="0 0 180 120" role="img" aria-label="velox logo">
            <defs>
                <linearGradient id="veloxRust" x1="0" y1="0" x2="1" y2="1">
            ...
            <rect x="42" y="16" width="132" height="50" rx="10" fill="url(#veloxRust)" />

...
see [serve images air-gapped](air-gapped.md).
...
[cache images for CI](ci-cache.md).
...
credentials. See [Docker Hub names and upstream auth](../hub-names-and-auth.md).

## Related

- The setting, value by value: [index settings](../reference/settings.md)
- A start-to-finish walkthrough: [pull a Docker Hub official image](../tutorials/hub-official-images.md)
- The full role walkthrough: [run a container registry](container-registry.md)

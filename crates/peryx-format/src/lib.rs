...
//!
//! It owns the [`Ecosystem`] axis and the neutral [`Lexicon`]. peryx implements the Python ecosystem
//! today (the `peryx-ecosystem-pypi` crate); further ecosystems (npm, crates, OCI, …) are sibling
